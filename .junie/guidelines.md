...
- Prereqs: Ruby, Bundler, Sqlite3, Node is not required (importmap), Chrome/Chromedriver for system tests.
...
- Utilities available: container, p-* spacing, fs-* type scale, flex, items-center, justify-*, gap-*. Add only when
  duplication emerges.
